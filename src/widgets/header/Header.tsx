...
export function Header({ mobileTitle }: HeaderProps) {
    ...
    const resolvedMobileTitle = mobileTitle ?? activeItem.label;
    ...
    return (
        <header className="header">
            ...
            <div className="header__mobile">
                ...
                <span className="header__mobile-title">{resolvedMobileTitle}</span>
            ...
            <div className={cn('header__mobile-menu', isOpen && 'header__mobile-menu--open')}>
                ...
                <div className="header__mobile-actions">
                    <a className="header__call" href="tel:+79114047303">
                        Позвонить
                    </a>
