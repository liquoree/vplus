...
export function TemplateInfoPage({ title, description, children }: { title: string; description: string; children: React.ReactNode }) {
  return (
    <div className="template-info-page">
      <div className="template-info-page__inner">
        ...
        <div className="template-info-page__content">
          {children}
        </div>
      </div>
    </div>
