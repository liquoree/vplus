                ...
                <div className="booking-modal__content">
                    ...
                    {isSuccess ? (
                        ...
                        <p className="booking-modal__error-text">
                            Заявка не была отправлена. Это могло произойти из-за отмены оплаты, ошибки банка
                            или истечения времени ожидания. Попробуйте отправить заявку ещё раз. Если ошибка
                            повторится, свяжитесь с нашим менеджером: +7 (911) 404-73-03.
                        </p>
                    )}
