...
export function getBookingOptionById(
...
export function getBookingOptionsByService(
  options: CatalogBookingOption[],
  serviceId: string
) {
  return options
...
export function getBookableCatalogItems(
  items: CatalogItem[]
): BookableCatalogItem[] {
  return items.filter(
    (item): item is BookableCatalogItem =>
...
export function getServiceCatalogItems(
  items: CatalogItem[]
): ServiceItem[] {
  return items.filter(
    (item): item is ServiceItem =>
