...
type AdminCatalogApiVehicle =
  AdminCatalogApiItemCommon & {
    kind: 'vehicle';
    season: Season;
  };

type AdminCatalogApiService =
  AdminCatalogApiItemCommon & {
    kind: 'service';
  };

type AdminCatalogApiPackage =
  AdminCatalogApiItemCommon & {
    kind: 'package';
...
type AdminCatalogApiItem =
  | AdminCatalogApiVehicle
  | AdminCatalogApiService
  | AdminCatalogApiPackage;
