...
import type { ContactErrors, ContactValues } from '../model/types';

import { SmartCaptcha } from '@/widgets';
...
type BookingContactsProps = {
    ...
    onChange: <Key extends keyof ContactValues>(key: Key, value: ContactValues[Key]) => void;
    ...
    return (
        <div className="booking-page__contacts">
            <div className="booking-page__contacts-inner">
                <h2 className="booking-page__contacts-title">Ваши контактные данные</h2>
                ...
                <div className="booking-page__verification">
                        ...
                        <div className="booking-page__agreement-item">
                            <div className="booking-page__agreement">
                                <input
                                    id="booking-terms"
                                    type="checkbox"
                                    checked={values.bookingTerms}
                                    onChange={(event) =>
                                        onChange('bookingTerms', event.target.checked)
                                    }
                                />

                                <span>
                                    <label htmlFor="booking-terms">Ознакомлен и согласен с </label>
                                    ...
                                    >
                                        Условиями бронирования и аренды
                                    </a>
                                </span>
                            </div>
                        ...
                        <div className="booking-page__agreement-item">
                            <div className="booking-page__agreement">
                                <input
                                    ...
                                    onChange={(event) =>
                                        onChange('personalData', event.target.checked)
                                    }
                                />

                                <span>
                                    <label htmlFor="personal-data-consent">Даю согласие на </label>
                    ...
                    <div className="booking-page__captcha-wrapper">
                        ...
                        {captchaError && (
                            <span className="booking-page__captcha-error">{captchaError}</span>
                        )}
                    </div>
                </div>
