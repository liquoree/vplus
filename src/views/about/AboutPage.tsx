    ...
    return (
        <div className="about-page">
            ...
            <main className="about-page__main">
                <TemplateInfoPage title="О нас" description="Что мы за компания?">
                    <div className="about-page__content">
                        <div className="about-page__info">
                            <section className="about-page__card">
                                <h2 className="about-page__card-title">ВЕЗДЕХОД+ Карелия</h2>

                                <p className="about-page__text">
                                    ВЕЗДЕХОД+ Карелия — аренда техники для активного отдыха на берегу Онежского озера.
                                    Предлагаем прокат квадроциклов, лодок, SUP-бордов и другой техники для отдыха в
                                    Карелии. Организуем прогулки, обучение и практические занятия с опытными
                                    инструкторами. Техника подходит для самостоятельных поездок, семейного отдыха,
                                    рыбалки, водных прогулок и знакомства с природой Карелии.
                                </p>

                                <ul className="about-page__advantages">
                                    {advantages.map((advantage) => (
                                        <li className="about-page__advantage" key={advantage}>
                                            <Image
                            ...
                            <section className="about-page__card">
                                <h2 className="about-page__card-title">Контакты</h2>
                                ...
                                <div className="about-page__contacts">
                                    ...
                                    <address className="about-page__contact about-page__address">
                                        ...
                                        <span>
                                            Республика Карелия, Прионежский район, Деревянское
                                            сельское поселение, Онежский парк, Большая Прибрежная
                                            улица, 1,
                                        </span>
                                    </address>
                                </div>
