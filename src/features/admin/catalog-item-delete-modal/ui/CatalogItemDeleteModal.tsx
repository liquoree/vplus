  ...
  return (
    <div className="catalog-item-delete-modal">
      ...
      >
        ...
        <h2
          className="catalog-item-delete-modal__title"
        ...
        >
          Позиция «{itemTitle}» и связанные с ней
          опции бронирования будут удалены.
        </p>

        {error && (
          <p
            className="catalog-item-delete-modal__error"
            role="alert"
          >
            {error}
          </p>
